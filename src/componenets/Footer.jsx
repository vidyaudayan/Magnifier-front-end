...
const Footer = () => {
  return (
    <footer className="bg-blue-300 lg:h-[300px] mt-10 text-black text-sm py-2">
      <div className="max-w-7xl mr-6 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap justify-between ">
          ...
          {/* Quick Links */}
          <div className="w-full pl-3 sm:w-1/2 lg:w-1/4">
          ...
          {/* Social Media */}
          <div className="w-full pl-3 sm:w-1/2 lg:w-1/4 mb-2">
        ...
        {/* Bottom Section */}
        <div className="border-t border-gray-800 font-semibold mt-1 pt-2 text-center">
