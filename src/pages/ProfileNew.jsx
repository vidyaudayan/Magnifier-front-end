    ...
    <div className="flex flex-col  items-center">
      ...
      <div className="w-full max-w-3xl mt-8 p-6 ">
        ...
        <div className="space-y-6 mt-3 ">
          {posts.length > 0 ? (
            posts.map((post) => (
              <div key={post._id} className="bg-white p-4 rounded-lg mb-8 border border-blue-50 hover:border-blue-100 shadow-lg">
                ...
                <div>
                  ...
                  />
                  <button className="bg-blue-500 text-white px-4 py-1 mt-2 rounded-md" onClick={() => handleAddComment(post._id)}>
                    Add Comment
                  </button>*/}
